    ...
    def solve(self):
        ...
        while len(forwardHeap) != 0 and len(backwardHeap) != 0 and timeLeft:
            ...
            if forwardCoords in self._backwardHash:
                ...
                self._setSuccess(minPath, minCost + self.getCostOfPoint(self._destination), len(minPath))
                return self
